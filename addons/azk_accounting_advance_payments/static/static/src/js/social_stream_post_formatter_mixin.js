odoo.define('social_instagram.stream_post_formatter_mixin', function (require) {
"use strict";
...
SocialStreamPostFormatterMixin._formatStreamPost = function (formattedValue) {
    ...
    return formattedValue
        .replace(/\B#([a-zA-Z\d-]+)/g, "<a href='https://instagram.com/explore/tags/$1' target='_blank'>#$1</a>");
};
